...
$(document).ready(function () {
    ...
    $('#Growth_Drivers_imput').on('click', function (e) {
        $('.Sales_Winning .finish').hide();
        $('.Sales_Winning .next').show();
    ...
    var Next = function (url) {
        $.when(Ajax(url)).then(function (data) {
            ...
            FJS.addCriteria({field: 'Sector', ele: '#Sector input:radio'});
            FJS.addCriteria({field: 'LearningType', ele: '#LearningType input:radio'});
